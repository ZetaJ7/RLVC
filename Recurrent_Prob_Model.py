...
# I_level, Height, Width, batch_size, Channel, \
# activation, GOP_size, GOP_num= helper.configure(args)
#
# path=args.path
# path_com = args.output + '/frames/'
# path_bin = args.output + '/bitstreams/'
# path_lat = args.output + '/latents/'
...
bpp_video = total_bits/frames_input/h_input/w_input
